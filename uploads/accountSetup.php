                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="accountName" id="accountName" value="<?php echo $resRow['accountName']; ?>"
                                                    autocomplete="off"
                                                    placeholder="Our Zanz" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="<?php echo $resRow['name']; ?>" name="ownerName"
                                                    class="form-control" id="ownerName" placeholder="Queue" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control" id="address1" name="address1"
                                                    placeholder="P.o Box 4146" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required><?php echo $resRow['address_one']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <textarea class="form-control" id="address2" name="address2"
                                                    placeholder="Jambiani" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required><?php echo $resRow['address_two']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" value="<?php echo $resRow['zipCode']; ?>" class="form-control" name="zipCode"
                                                    id="zipCode" placeholder="4146" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" value="<?php echo $resRow['city']; ?>" name="city" id="city"
                                                    placeholder="Zanzibar" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="email" class="form-control" name="email" id="email" value="<?php echo $resRow['email']; ?>"
                                                    placeholder="inventory@our-zanzibar.com" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="tel" class="form-control" name="phone" id="phone" value="<?php echo $resRow['phone']; ?>"
                                                    placeholder="+255743419217" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row align-items-center acntStp-Row">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" name="taxId" id="taxId" value="<?php echo $resRow['taxId']; ?>"
                                                    placeholder="1001/4567892" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required>
                                            </div>
                                        </div>
                                    </div>
