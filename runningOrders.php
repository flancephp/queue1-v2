...
<style>
    ...
    .srNum { color: #666C85;font-weight:600; }
    ...
    @media(max-width:767px){
        ...
        .modal .table-cell { padding: 1px 5px;font-size:5px;line-height: 1.3; }
    ...
    @media(min-width:992px) {
        #modalfiltertop { position: absolute;top:.75rem !important; left:4rem; } 
    }
    ...
    .modal-head-row .btn { line-height: 1; }
    .cnfrm, .doc-bx, .dlt-bx { border-radius:6px; }
    .nav-bar a { color: #8C8FA7; }
    a.active {
        color: #fff !important;
    }
    .btn-primary {
            ...
            ?>
                <div class="task update">
                    ...
                    <div
                        ...
                        <div class="fxdhtBox">
                            <div class="<?php if($orderRow['ordType'] == 1) { echo 'mbSbarord'; } else { echo 'mbSbar'; } ?>">&nbsp;</div>
                            <div class="align-items-center dskDetail">
                                <div
                                    class="d-flex align-items-center runDetail <?php if($orderRow['ordType'] == 1) { echo 'reqDtl-Bg'; } else { echo 'mbrDtl-Bg'; } ?>">
                                    <div
                                        class="<?php if($orderRow['ordType'] == 1) { echo 'ordType';  } else {echo 'reqType'; } ?> ">
                                        &nbsp;</div>
                                    <div class="d-flex align-items-center ordeReq">
                                        <div
                                            class="p-1 reqDtl <?php if($orderRow['ordType'] == 1) { echo 'supMem-Name'; } else { echo 'member-Name'; } ?> ">
                                            <p><?php if($orderRow['ordType'] == 1) { echo $orderRow['supplierName'];  } else { echo $orderRow['deptMem']; } ?>
                                            </p>
                                        </div>
