            ...
            <div class="modal-content">
                ...
                <form class="addUser-Form row" id="unitfrm" name="unitfrm" action="" method="post">
                    <div class="modal-body">
                        ...
                        <input oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required type="text" class="form-control" name="name" id="name" placeholder="<?php echo showOtherLangText('Name') ?>*">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required class="form-control" id="editUnit" name="editUnit" placeholder="<?php echo showOtherLangText('Name') ?>*">
