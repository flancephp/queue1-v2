...
$sql = " SELECT * FROM tbl_designation_sub_section_permission WHERE type = 'department_type' AND designation_Section_permission_id = '8' AND designation_id = '" . $_SESSION['designation_id'] . "' AND account_id = '" . $_SESSION['accountId'] . "' ";
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="text" class="form-control" autocomplete="off" value="" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" onChange="this.setCustomValidity('')" required id="name" name="name" placeholder="<?php echo showOtherLangText('Department Name'); ?>*">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" name="id" id="edit-id" value="" /> <input type="text" class="form-control" name="editname" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" onChange="this.setCustomValidity('')" required id="editname" placeholder="<?php echo showOtherLangText('Department Name'); ?>*">
