                ...
                <section class="usr-info stockUser">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">נהל קטגוריות משנה (משקאות)</h1>
                        </div>
                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="categories_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                                ...
                                <div class="btnBg">
                                    <a href="javascript:void(0)" class="sub-btn std-btn mb-usrBkbtn"
                                        data-bs-toggle="modal" data-bs-target="#add-Sub_category"><span
                                            ...
                                            <span class="nstdSpan">תַת. קטגוריה</span></span> <span
                                            class="dsktp-Btn">הוסף קטגוריית משנה</span></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title h1">הוסף קטגוריית משנה</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="addSub-Category" placeholder="קטגוריית משנה">
                    </form>
                </div>
    ...
    <div class="modal" tabindex="-1" id="edit-Sub_Category" aria-labelledby="edit-Sub_CategoryLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h1 class="modal-title h1">ערוך קטגוריית משנה</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="editSub-Category" placeholder="קטגוריית משנה">
                    </form>
                </div>
                <div class="modal-footer">
                    <div class="btnBg">
