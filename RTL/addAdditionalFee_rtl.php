                ...
                <section class="usr-info stockUser">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">הוסף עמלה נוספת</h1>
                        </div>
                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="manageAdditionalFee_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                        ...
                        <div class="edtSup-Div">
                            <form class="addUser-Form acntSetup-Form">
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="feeType" class="form-label">סוג עמלה</label>
                                    </div>
                                    <div class="col-md-9">
                                        <select class="form-select" aria-label="Default select example" id="feeType">
                                            <option selected="">הנחה קבועה</option>
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="feePercentage" class="form-label">אחוז עמלות (+/-)</label>
                                    </div>
                                    <div class="col-md-9">
