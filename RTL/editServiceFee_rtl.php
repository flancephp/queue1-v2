                ...
                <section class="usr-info stockUser">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">ערוך עמלת שירות</h1>
                        </div>
                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="manageServiceFee_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <button type="submit" class="btn sub-btn std-btn mb-usrBkbtn"><span
                                            ...
                                            class="dsktp-Btn">לַעֲרוֹך</span></button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="edtSup-Div">
                            <form class="addUser-Form acntSetup-Form">
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="feeName" class="form-label">שם עמלה</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="feeName"
                                            placeholder="עמלת אייס הובלה">
                                    </div>
                                </div>

                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="feeAmount" class="form-label">סכום עמלה $</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="feeAmount" placeholder="20">
                                    </div>
                                </div>

                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="unit" class="form-label">יחידה</label>
                                    </div>
                                    <div class="col-md-9">
