                ...
                <section class="usr-info stockUser">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">ניהול עמלת שירות</h1>
                        </div>
                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <a href="addServiceFee_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span class="mb-UsrBtn"><i
                                    ...
                                    <div class="serFeeTbl-body itmBody">
                                        ...
                                        <div class="srvFeeTbl-IcnCol">
                                            <div class="tb-bdy feeOpt-Clm d-flex align-items-center">
                                                <a href="editServiceFee_rtl.php" class="userLink">
