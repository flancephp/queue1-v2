                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <button type="submit" class="btn sub-btn std-btn mb-usrBkbtn"><span
                                        ...
                                        <span class="dsktp-Btn">לְהוֹסִיף</span></button>
                        ...
                        <div class="acntStp">
                            <form class="addUser-Form acntSetup-Form row">
                                <div class="acnt-Div">
                                    ...
                                    <div class="row align-items-center acntStp-Row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="accountName"
                                                placeholder="זנזיבר שלנו">
                                        </div>
                                    </div>

                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="ownerName" class="form-label">שם הבעלים</label>
                                        </div>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="ownerName" placeholder="תוֹר">
                                        </div>
                                    </div>

                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="streetAdd-1" class="form-label">כתובת רחוב 1</label>
                                        </div>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="streetAdd-1"
                                                placeholder="תיבת דואר 4146"></textarea>
                                        </div>
                                    </div>

                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="streetAdd-2" class="form-label">כתובת רחוב 2</label>
                                        </div>
                                        <div class="col-md-9">
                                            <textarea class="form-control" id="streetAdd-2"
                                                placeholder="ג'מביאני"></textarea>
                                        </div>
                                    </div>

                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="inputZip" class="form-label">מיקוד</label>
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="inputCity" class="form-label">עִיר</label>
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="selectCountry" class="form-label">מדינה</label>
                                        </div>
                                        <div class="col-md-9">
                                            <select class="form-select" aria-label="Default select example"
                                                id="selectCountry">
                                                <option selected>בחר מדינה</option>
                                    ...
                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="taxId" class="form-label">מַס אניד</label>
                                        </div>
                                        <div class="col-md-9">
                                ...
                                <div class="acntLg-Upld">
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="labelDiv">
                                            <label class="imgUploadCss" id="imgLabel" for="imgUpload"> העלה לוגו
