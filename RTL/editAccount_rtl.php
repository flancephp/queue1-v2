                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="manageAccounts_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                        ...
                        <div class="edtSup-Div">
                            <form class="addUser-Form acntSetup-Form">
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="accountName"
                                            placeholder="מכירה עיקרית בדולר ארה"ב">
                                    </div>
                                </div>

                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="accountNumber" class="form-label">מספר חשבון</label>
                                    </div>
                                    <div class="col-md-9">
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="accountCurrency" class="form-label">מטבע חשבון</label>
                                    </div>
                                    <div class="col-md-9">
                                        <select class="form-select" aria-label="Default select example" id="accountCurrency">
                                            <option selected>דולר אמריקאי</option>
                                            <option value="1">יורו</option>
                                            <option value="2">צס</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="accountBalance" class="form-label">איזון</label>
                                    </div>
                                    <div class="col-md-9">
