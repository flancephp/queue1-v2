                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="users_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span class="mb-UsrBtn"><i
                        ...
                        <div class="adUsr-Div">
                            <form class="addUser-Form row">
                                <input type="text" class="form-control" id="inputName" placeholder="שֵׁם">

                                <select class="form-select" aria-label="Default select example">
                                    <option selected>בחר כותרת</option>
