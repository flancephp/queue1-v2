...
<body>
    ...
    <div class="container-fluid newOrder">
        <div class="row">
                    ...
                    <div>
                        ...
                        <div class="nav-bar">
                            <ul class="nav flex-column h2">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="revenueCenter_rtl.php"><img src="../Assets/icons/Database.svg"
            ...
            <div class="cntArea">
                <section class="usr-info history-info revCenter-info">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">מרכזי הכנסות</h1>
                        </div>
                        ...
                        <div class="alrtMessage">
                            <div class="container">
                                <div class="alert alert-success alert-dismissible fade show" role="alert">
                                    <p><strong>שלום משתמש!</strong> נתוני מכירות של Ezee יובאו בהצלחה.</p>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>

                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <p><strong>שלום משתמש!</strong> שגיאה בעת ייבוא ​​נתונים.</p>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="issueDtl salesDtl">
                                    <div class="d-flex main-Sldiv">
                                        <div class="gstNo">
                                            <div class="guestNum d-flex">
                                                <div class="text-center">
                                                    <p class="gst-Head">מספר אורחים</p>
                                        ...
                                        <div class="ttlCost">
                                            <p class="tl-Cst text-center">עלות כוללת</p>
                                            ...
                                            <div class="d-flex cst-Col">
                                                <div class="col-md-5">
                                                    <p class="sl-Cost">עלות מכירה</p>
                                                    <p class="sl-Usage">נוֹהָג</p>
                                                    <p class="sl-Variance">שׁוֹנוּת</p>
                                                </div>
                                                <div class="col-md-7">
                                    ...
                                    <div class="revFeat position-relative text-center">
                                        <a href="javascript:void(0)" class="dropdown-toggle tabFet" role="button"
                                            ...
                                            <p class="btn2 d-flex justify-content-center align-items-center">
                                                <span>קבל נתונים</span> <i class="fa-solid fa-angle-down"></i>
                                            </p>
                                        </a>

                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item ent-Gstno" href="javascript:void(0)">הזן מספר אורח.</a>
                                            </li>
                                            <li><a class="dropdown-item gt-Pos" href="javascript:void(0)">קבל מכירות POS</a>
                                            </li>
                                            <li><a class="dropdown-item imp-Data" href="javascript:void(0)">ייבוא ​​קובץ נתונים</a></li>
                                ...
                                <div class="rev-Cntrgst align-items-center">
                                    <div class="tb-head d-flex align-items-center rev-List">
                                        <div class="dropdown d-flex position-relative">
                                            <a class="dropdown-toggle body3" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <span>מרכז הכנסות</span> <i class="fa-solid fa-angle-down"></i>
                                            </a>
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="javascript:void(0)">מרכז הכנסות
                                                        1</a>
                                                </li>
                                                <li><a class="dropdown-item" href="javascript:void(0)">מרכז הכנסות
                                                        2</a>
                                    ...
                                    <div class="out-Let align-items-center">
                                        <div class="tb-head d-flex align-items-center out-List">
                                            <div class="dropdown d-flex position-relative">
                                                <a class="dropdown-toggle body3" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                                    <span>מוֹצָא</span> <i class="fa-solid fa-angle-down"></i>
                                                </a>
                                                <ul class="dropdown-menu">
                                                    <li><a class="dropdown-item" href="javascript:void(0)">מוֹצָא
                                                            1</a>
                                                    </li>
                                                    <li><a class="dropdown-item" href="javascript:void(0)">מוֹצָא
                                                            2</a>
                                ...
                                <div class="revCntr-Task align-items-center">
                                    <div class="mbshw-Revcnt">
                                        <div class="revCenter-Name d-flex align-items-center itmBody">
                                            ...
                                            <div class="num-List">
                                                <p><span class="mbguest-Head">אורחים</span> 20</p>
                                            </div>
                                        </div>
                                ...
                                <div class="revCntr-Task align-items-center mt-1">
                                    <div class="mbshw-Revcnt">
                                        <div class="revCenter-Name d-flex align-items-center itmBody">
                                            ...
                                            <div class="num-List">
                                                <p><span class="mbguest-Head">אורחים</span> 43</p>
                                            </div>
                                        </div>
                                        <div class="revCenter-Dtl">
                                            <div class="revtable-Detail d-flex align-items-center itmBody">
