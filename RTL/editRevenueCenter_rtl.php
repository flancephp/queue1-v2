                ...
                <section class="usr-info stockUser">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">ערוך את מרכז ההכנסות</h1>
                        </div>
                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="revenueCenterSetup_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    ...
                                    <button type="submit" class="btn sub-btn std-btn mb-usrBkbtn"><span class="mb-UsrBtn"><i
                                                class="fa-regular fa-floppy-disk"></i></span> <span
                                            class="dsktp-Btn">להציל</span></a></button>
                                </div>
                            </div>
                        </div>
                            ...
                            <form class="addUser-Form acntSetup-Form edtRev-cntr row">
                                <div class="col-md-6">
                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="Name" class="form-label">שֵׁם</label>
                                        </div>
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="Name" placeholder="קאזה">
                                        </div>
                                    </div>
                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="ezzeAddress" class="form-label">הקצה כתובת אזי</label>
                                        </div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row align-items-start acntStp-Row">
                                        <div class="col-md-3">
                                            <label for="" class="form-label">הגדר קטגוריית אזי</label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="setEze-Ctgry" style = "display:none;">
                                                <input type="text" class="form-control" id="" placeholder="משקאות חמים">
                                            ...
                                            <a href="javascript:void(0)" class="ezeCat-All" style = "display:none;">
                                                <span>כל הקטגוריות</span> <i class="fa-solid fa-angle-down"></i>
                                            </a>
                                ...
                                <div class="col-md-6">
                                    <div class="row align-items-center acntStp-Row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control" id="address" placeholder="רָאשִׁי">
                                        </div>
                                    </div>
                                    <div class="row align-items-center acntStp-Row">
                                        <div class="col-md-3">
