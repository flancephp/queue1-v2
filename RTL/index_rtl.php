                ...
                <section class="ordDetail">
                    <div class="stcPart">
                        <div class="row ordRow">
                            <div class="col-md-6">
                                <div class="ordNum">
                                    <h4 class="subTittle1"><span>מְשִׁימָה#:</span> <span>332974</span></h4>
                                </div>
                            </div>
                        ...
                        <div class="container topOrder">
                            <div class="row">
                                <div class="sltSupp">
                                    ...
                                    <div class="btn-group glb-btn">
                                        <button type="button"
                                            ...
                                            data-bs-toggle="dropdown" aria-expanded="false"><span>-בחר ספק-</span> <i class="fa-solid fa-angle-down"></i></button>
                                        <ul class="dropdown-menu">
                                                ...
                                                <div class="col-md-5 text-center">
                                                    <div class="row featRow">
                                                        <div class="col-md-4 ordFeature"><a href="javascript:void(0)"
                                                                ...
                                                                <p class="btn2">צפה בהזמנה</p>
                                                            </a>
                                                        </div>
                                                        <div
                                                            class="col-md-4 ordFeature border-start border-end dropdown drpCurr position-relative">
                                ...
                                <div class="smBtn">
                                    <div class="btnBg">
                                        <a href="editOrder_rtl.php" class="btn sub-btn"><span
                                                class="align-middle">שלח</span> <i
