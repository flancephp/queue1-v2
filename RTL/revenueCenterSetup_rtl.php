                ...
                <section class="usr-info stockUser">
                    <div class="row">
                        <div class="col-md-4 d-flex align-items-end">
                            <h1 class="h1">הגדרת מרכז ההכנסות</h1>
                        </div>
                            ...
                            <div class="acc-info">
                                ...
                                <div class="dropdown d-flex">
                                    <a class="dropdown-toggle body3" data-bs-toggle="dropdown">
                                        <span> דוֹ'חַ</span> <i class="fa-solid fa-angle-down"></i>
                                    </a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="javascript:void(0)">דוֹ'חַ 1</a></li>
                                        <li><a class="dropdown-item" href="javascript:void(0)">דוֹ'חַ 2</a></li>
                                        <li><a class="dropdown-item" href="javascript:void(0)">דוֹ'חַ 3</a></li>
                                        <li><a class="dropdown-item" href="javascript:void(0)">דוֹ'חַ 4</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <a href="addRevenueCenter_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                                    ...
                                    <div class="revstpTbl-body align-items-center itmBody">
                                        <div class="revstpTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy revstpName-Clm">
                                                <p class="userName">קאזה</p>
                                            </div>
                                        </div>
                                        <div class="revstpTbl-Icns">
                                            <div class="tb-bdy revstpOpt-Clm d-flex align-items-center">
                                                <a href="editRevenueCenter_rtl.php" class="userLink">
                                ...
                                <div class="userTask">
                                    <div class="revstpTbl-body align-items-center itmBody">
                                        <div class="revstpTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy revstpName-Clm">
                                                <p class="userName">זנזיבר שלנו</p>
                                            </div>
                                        </div>
                                        <div class="revstpTbl-Icns">
                                            <div class="tb-bdy revstpOpt-Clm d-flex align-items-center">
