                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            <div class="usrBk-Btn">
                                <div class="btnBg">
                                    <a href="manageCurrency_rtl.php" class="sub-btn std-btn mb-usrBkbtn"><span
                        ...
                        <div class="edtSup-Div">
                            <form class="addUser-Form acntSetup-Form">
                                ...
                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="currency" class="form-label">מַטְבֵּעַ</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="currency" placeholder="יורו">
                                    </div>
                                </div>

                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="currencyCode" class="form-label">קוד מטבע</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="currencyCode" placeholder="€">
                                    </div>
                                </div>

                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="amountAgainst" class="form-label">סכום מול $1</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="amountAgainst" placeholder="0.89">
                                    </div>
                                </div>

                                <div class="row align-items-center acntStp-Row">
                                    <div class="col-md-3">
                                        <label for="noDecimal" class="form-label">מספר של מקום עשרוני</label>
                                    </div>
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" id="noDecimal" placeholder="4">
                                    </div>
                                </div>
