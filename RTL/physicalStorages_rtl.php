                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <a href="addCategory_rtl.php" class="sub-btn std-btn mb-usrBkbtn" data-bs-toggle="modal"
                                        data-bs-target="#add-PhyStorage"><span class="mb-UsrBtn"><i
                                                class="fa-solid fa-plus"></i><span class="nstdSpan">חנות</span></span> <span class="dsktp-Btn">הוסף חנות</span></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="phyStrgTbl-body align-items-center itmBody">
                                        <div class="phyStrgTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy phyStrgName-Clm">
                                                <p class="userName">חנות מרכזית למוצרים יבשים</p>
                                            </div>
                                        </div>
                                        <div class="phyStrgTbl-Icns">
                                ...
                                <div class="userTask">
                                    <div class="phyStrgTbl-body align-items-center itmBody">
                                        <div class="phyStrgTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy phyStrgName-Clm">
                                                <p class="userName">ה.ק. אִחסוּן</p>
                                            </div>
                                        </div>
                                        <div class="phyStrgTbl-Icns">
                                            <div class="tb-bdy phyStrgOpt-Clm d-flex align-items-center">
                                ...
                                <div class="userTask">
                                    <div class="phyStrgTbl-body align-items-center itmBody">
                                        <div class="phyStrgTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy phyStrgName-Clm">
                                                <p class="userName">ש.ק. אִחסוּן</p>
                                            </div>
                                        </div>
                                        <div class="phyStrgTbl-Icns">
                                            <div class="tb-bdy phyStrgOpt-Clm d-flex align-items-center">
                                ...
                                <div class="userTask">
                                    <div class="phyStrgTbl-body align-items-center itmBody">
                                        <div class="phyStrgTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy phyStrgName-Clm">
                                                <p class="userName">אחסון משקאות</p>
                                            </div>
                                        </div>
                                        <div class="phyStrgTbl-Icns">
                                            <div class="tb-bdy phyStrgOpt-Clm d-flex align-items-center">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title h1">הוסף חנות</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="Name" placeholder="שֵׁם">
                    </form>
                </div>
    ...
    <div class="modal" tabindex="-1" id="edit-PhyStorage" aria-labelledby="edit-PhyStorageLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h1 class="modal-title h1">ערוך חנות</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
