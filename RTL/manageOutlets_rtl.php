                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <a href="javascript:void(0)" class="sub-btn std-btn mb-usrBkbtn"><span class="mb-UsrBtn"><i class="fa-solid fa-plus"></i>
                                            <span class="nstdSpan">מוֹצָא</span></span> <span class="dsktp-Btn">הוסף אאוטלט</span></a>
                                </div>
                            </div>
                        </div>
