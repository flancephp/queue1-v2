                                ...
                                <div class="btnBg">
                                    <a href="javascript:void(0)" class="sub-btn std-btn mb-usrBkbtn"
                                        data-bs-toggle="modal" data-bs-target="#add-Category"><span class="mb-UsrBtn"><i
                                            ...
                                            <span class="nstdSpan">קטגוריה</span></span> <span class="dsktp-Btn">הוסף קטגוריה</span></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="catgryTbl-body align-items-center itmBody">
                                        <div class="catgryTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy catgryName-Clm">
                                                <p class="userName">מזון</p>
                                            </div>
                                        </div>
                                        <div class="catgryTbl-Icns">
                                            <div class="tb-bdy catgryOpt-Clm d-flex align-items-center">
                                                <a href="javascript:void(0)" class="userLink edt_CatLnk"
                                                    data-bs-toggle="modal" data-bs-target="#edit-Category">
                                                    <img src="../Assets/icons/dots.svg" alt="Dots" class="usrLnk-Img">
                                                </a>
                                                <a href="javascript:void(0)" class="userLink dlt_CatLnk">
                                                    <img src="../Assets/icons/delete.svg" alt="Delete" class="usrLnk-Img">
                                                </a>
                                                <a href="subCategoriesBeverage_rtl.php" class="userLink sub_CatLnk">
                                                    <img src="../Assets/icons/setting.svg" alt="Sub-Category"
                                                        class="usrLnk-Img">
                                                    <p class="subCat-Lnk">תת ג<span class="dsk-HdCtgry">.</span><span
                                                            class="mb-HdCtgry">קטגוריה</span></p>
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="catgryTbl-body align-items-center itmBody">
                                        ...
                                        <div class="catgryTbl-Icns">
                                            <div class="tb-bdy catgryOpt-Clm d-flex align-items-center">
                                                ...
                                                <a href="subCategoriesBeverage_rtl.php" class="userLink subCatLnk">
                                                    <img src="../Assets/icons/setting.svg" alt="Sub-Category"
                                                        class="usrLnk-Img">
                                                    <p class="subCat-Lnk">תת ג<span class="dsk-HdCtgry">.</span><span
                                                            class="mb-HdCtgry">קטגוריה</span></p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title h1">הוסף קטגוריה</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="editCategory" placeholder="קטגוריה">
                    </form>
                </div>
    ...
    <div class="modal" tabindex="-1" id="edit-Category" aria-labelledby="edit-CategoryLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h1 class="modal-title h1">ערוך קטגוריה</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="editCategory" placeholder="קטגוריה">
