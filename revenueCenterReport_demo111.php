                    ...
                    <div class="header__area rcSpace1">
                        ...
                        <section class="container hisData">
                            ...
                            <div class="container hisData">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="hstCal">
                                            ...
                                            <form action="revenueCenterReport_demo.php" id="frm" name="frm" method="get">
                                                <div class="prtDate">
                                                    <div class="hstDate">
                                                    ...
                                                    <div class="reloadBtn">
                                                        <a href="javascript:void(0)" onClick="window.location.href='revenueCenterReport_demo.php';"><i class="fa-solid fa-xmark"></i></a>
                                                    </div>
                                                </div>
                                            </form>
                                            <!-- Date Box End -->
                                ...
                                <form action="revenueCenterReport_demo.php" id="frmMobile" name="frmMobile" method="get">
                            ...
                            while ($row = mysqli_fetch_array($getRevenueReport)) {
                                ...
                                $ourLetsTotsArr = getRevenueTotals_old($row['outLetId'], $_GET['fromDate'], $_GET['toDate']);
                            ...
                            <div class="container mb-hisDtl res__mb">
                                <div class="row">
                                    <div class="col-md-5 is-Incol">
                                        ...
                                        <p class="ttlAmount"><?php showPrice($salesTotal, $getDefCurDet['curCode']); ?></p>
                                    </div>
                                    <div class="col-md-5 is-Outcol">
                                        <p class="tl-Cst"><?php echo showOtherLangText('Total Cost'); ?></p>
                                        <p class="ttlAmount-rec"><?php echo showPrice($usageTotalAmount, $getDefCurDet['curCode']); ?></p>
                                    </div>
                                        ...
                                        <div class="tb-head d-flex align-items-center rev-List">
                                            <div class="dropdown d-flex position-relative">
                                                ...
                                                GROUP BY rc.id order by rc.name desc ";
                                                    ...
                                                    echo  '<li><a class="dropdown-item" href="revenueCenterReport_demo.php?fromDate=' . $_GET['fromDate'] . '&toDate=' . $_GET['toDate'] . '">All</a> </li>';

                                                    while ($revRow = mysqli_fetch_array($resultSet)) {
                                                        $sel = isset($_GET['centerId']) && $_GET['centerId'] == $revRow['id']  ? 'selected="selected"' : '';

                                                        echo  '<li><a class="dropdown-item" href="revenueCenterReport_demo.php?fromDate=' . $_GET['fromDate'] . '&toDate=' . $_GET['toDate'] . '&centerId=' . $revRow['id'] . '">' . $revRow['name'] . '</a> </li>';
                                                    }
