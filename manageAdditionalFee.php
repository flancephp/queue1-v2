                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <a href="addAdditionalFee.php" class="sub-btn std-btn mb-usrBkbtn"><span
                                            ...
                                            <span class="nstdSpan">Fee</span></span> <span class="dsktp-Btn"><?php echo showOtherLangText('Add Fee'); ?></span></a>
                                </div>
                            </div>
                        </div>
    ...
    $( "#dialog" ).dialog({  
        ...
        buttons   : {
          '<?php echo showOtherLangText('Yes') ?>' : function() {
            ...
            $(this).dialog('close');
            window.location.href='manageAdditionalFee.php?delId='+delId;
          },
