...
$ordPrice = $_SESSION['convertItemsPost']['qtyToConvert'] * $stockRow['stockPrice'];
...
$upQry = " UPDATE  `tbl_stocks` SET
			...
			`stockValue` = '" . (($stockRow['qty'] - $_SESSION['convertItemsPost']['qtyToConvert']) * $stockRow['stockPrice']) . "',
			`stockPrice` = '" . $stockRow['stockPrice'] . "'
