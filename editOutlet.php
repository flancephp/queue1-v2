        ...
        <div class="row">
            ...
            <div class="cntArea">
                ...
                <section class="ordDetail userDetail itmMngDetail">
                    <form action="" method="post" id="outletItemFrm" name="outletItemFrm">
                        <div>
    ...
    <div class="modal" tabindex="-1" id="edit-PhyStorage" aria-labelledby="edit-PhyStorageLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h1 class="modal-title h1"><?php //echo showOtherLangText('Edit store'); 
                                                ?></h1>
                </div>
                <div class="modal-body">
                ...
                <div class="modal-footer">
                    <div class="btnBg">
                        <button type="submit" class="btn sub-btn std-btn"><?php //echo showOtherLangText('Save'); 
                                                                            ?></button>
                    </div>
                </div>
            </div>
