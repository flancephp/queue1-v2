...
<tr>
  ...
  <tr><td class="text-center m-all ml-o pd-o"><label class="addClientText" id="addClientText">+ADD NEW CLIENT</label></td></tr>
...
$('#showHideExistingTable, #chooseClientTxt').css("display", "none");
...
$('#showHideExistingTable, #chooseClientTxt').css("display", "block");
