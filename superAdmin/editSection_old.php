      ...
      <table class="table">
           <tr>
                ...
                <tr>
                  <td>Default : </td>
                  <td>
                    <input type="radio" name="sectionType" id="sectionType">
                    <label>Yes</label>
                    <input type="radio" name="sectionType" id="sectionType">
                    <label>No</label>
                  </td>
                  ...
                  <tr class="button-group">
                    <td>
                      <button class="btn btn-info" onclick="window.location.href= 'manageSection.php' ">Save</button>
                    </td>
                    <td>
                      <button class="btn btn-info"  onclick="window.location.href= 'manageSection.php' ">Back</button>
                    </td>
                  </tr> 
