  ...
  <div class="container-fluid">
      <div class="row">
          ...
          <div class="col-md-10 col-sm-9 col-lg-10 content-clm">
            ...
            <div class="container-fluid">
              <div class="pull-right"><a href="addBusiness.php" data-toggle="tooltip" title="Add"
              ...
              <div class="panel-heading">
                  <h3 class="panel-title"><i class="fa fa-briefcase" aria-hidden="true"></i>
                      <span class="panel-span">Business</span>
                  </h3>
              </div>
            ...
            foreach(getAllbusiness() as $business) { ?>
                          <tr>
                              ...
                              <td><?php echo($business['status'])?'Active':'Deactive'; ?></td>
                              <td class="text-center">
                                  <a href="editBusiness.php?id=<?php echo $business['id']; ?>" class="btn btn-primary"
                                      data-toggle="edit" title="View"><span class="glyphicon glyphicon-edit"
                                          aria-hidden="true"></span></a>
                                  <a class="btn btn-danger delete_business" data-id="<?php echo $business['id']; ?>"><i
