...
if (isset($_POST['productIds'])) {
        ...
        if ($selectAtLeastOneItem === false) {
                echo '<script>window.location="editRequisition.php?orderId=' . $_GET['orderId'] . '&selectAtleastOneProduct=1"</script>';
        ...
        echo '<script>window.location="editRequisition.php?orderId=' . $_GET['orderId'] . '&newItemsAdded=1"</script>';
