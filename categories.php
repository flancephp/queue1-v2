                                ...
                                <div class="btnBg">
                                    <a href="javascript:void(0)" class="sub-btn std-btn mb-usrBkbtn"
                                        data-bs-toggle="modal" data-bs-target="#add-Category"><span class="mb-UsrBtn"><i
                                            ...
                                            <span class="nstdSpan">Category</span></span> <span class="dsktp-Btn">Add
                                            Category</span></a>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="catgryTbl-body align-items-center itmBody">
                                        ...
                                        <div class="catgryTbl-Icns">
                                            <div class="tb-bdy catgryOpt-Clm d-flex align-items-center">
                                                ...
                                                <a href="subCategoriesBeverage.php" class="userLink sub_CatLnk">
                                    ...
                                    <div class="catgryTbl-body align-items-center itmBody">
                                        ...
                                        <div class="catgryTbl-Icns">
                                            <div class="tb-bdy catgryOpt-Clm d-flex align-items-center">
                                                ...
                                                <a href="subCategoriesBeverage.php" class="userLink subCatLnk">
                                                    <img src="Assets/icons/setting.svg" alt="Sub-Category"
                                                        class="usrLnk-Img">
                                                    <p class="subCat-Lnk">Sub C<span class="dsk-HdCtgry">.</span><span
                                                            class="mb-HdCtgry">ategory</span></p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h1 class="modal-title h1">Add Category</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="editCategory" placeholder="Category">
                    </form>
                </div>
    ...
    <div class="modal" tabindex="-1" id="edit-Category" aria-labelledby="edit-CategoryLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    <h1 class="modal-title h1">Edit Category</h1>
                </div>
                <div class="modal-body">
                    <form class="addUser-Form row">
                        <input type="text" class="form-control" id="editCategory" placeholder="Category">
