                    ...
                    <div class="header__area rcSpace1">
                        ...
                        <section class="container hisData">
                            ...
                            while ($row = mysqli_fetch_array($getRevenueReport)) {
                                ...
                                $x++;
                                $getEasySalesAndGuestData = getEasySalesAndGuestData($_SESSION['accountId'], $row['outLetId'], $_GET['fromDate'], $_GET['toDate']);
                                $ourLetsTotsArr = getRevenueTotals($_SESSION['accountId'], $row['outLetId'], $_GET['fromDate'], $_GET['toDate']);

                                $sales = $getEasySalesAndGuestData['totalsSalesAmt'];
                                $guests = $getEasySalesAndGuestData['guests'];
                                $varience = $ourLetsTotsArr['varienceTotal'];
