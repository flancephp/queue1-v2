...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    ...
                    <h2 class="mblFnt2">Dry Products</h2>
                </div>
                <div class="col-md-6">
            ...
            <div class="d-flex align-items-center justify-content-between pt-3 upldClm">
                ...
                <a href="storageStocktaking6.php" class="fnshBtn">Finish & Upload <img src="Assets/icons/download.svg"
                        alt="Finish"></a>
            </div>
        </div>
    </section>
    ...
    <section class="finishSection">
        <div class="container">
            <div class="scflMsg">
                <p class="text-center">All <span class="numItems">4</span> items counted successfully</p>
            </div>
