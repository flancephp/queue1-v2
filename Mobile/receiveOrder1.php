...
<head>
    ...
    <title>Receiving1 - Queue1 Mobile</title>
...
<body>
    ...
    <section class="strgList">
        <div class="container">
            <a href="receiveOrder2.php" class="strgProduct receivePrd">
                <div class="row">
            ...
            <a href="receiveOrder2.php" class="strgProduct receivePrd mt-3">
                <div class="row">
                    <div class="col-md-6 storeClm">
                        <p class="storeName ttlStr-Cost">Total: <span>39.2157 $</span></p>
                        <p class="prdCode"># 107534</p>
