    ...
    <section class="homeList">
        <div class="container homeCont d-flex justify-content-between flex-wrap">
            <a href="storageStocktaking1.php" class="mblBx-Lnk text-center">
                ...
                <p class="mblFnt1">Storage Stocktaking</p>
            </a>
