...
<body>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 bckClm">
                    ...
                    <h2 class="mblFnt2">Start Production</h2>
            ...
            <div class="text-center">
                ...
                <a href="production4.php" class="fnshBtn doneBtn">Done</a>
    ...
    <section class="storeSection px-2 px-sm-0">
        ...
        <div class="container prdcn-Cntr">
                ...
                <div class="prdcnDetails">
                    ...
                    <div class="prdcnHide">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <p class="fw-bold">Starting Time:</p>
            ...
            <div class="storeDtl production-Store bg-white" style="background-image:none;border-radius:0 0 var(--radius) var(--radius);">
