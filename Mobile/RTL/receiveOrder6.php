...
<head>
    ...
    <title>Receiving6 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="receiveOrder5.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
    ...
    <section class="fnlSection">
        <div class="container">
            <div class="msgBx-Stock text-center">
                <h4>מזל טוב,</h4>
                <p>קבלה נשלחה בהצלחה לבדיקה.</p>
                <a href="index.php" class="homeBtn"><i class="fa-solid fa-arrow-left"></i> <span>בית</span></a>
            </div>
        </div>
    </section>
