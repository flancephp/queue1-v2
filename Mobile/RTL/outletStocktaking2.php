...
<body>
    ...
    <section class="headSec">
        <div class="container">
            ...
            <div class="text-center">
                <a href="outletStocktaking3.php" class="stockTake-Btn">התחל ביצוע מלאי</a>
            </div>
        </div>
    </section>
    ...
    <section class="storeSection">
        <div class="container">
            <div class="storeDtl">
                <h3 class="mblFnt2">אאוטלט סקירת מלאי</h3>
                <div class="d-flex justify-content-between align-items-center flex-wrap pt-3">
                    ...
                    <div class="stkData">
                        ...
                        <p class="storeType">חוף כיף</p>
                    </div>
                    <div class="stkData">
                        <p class="strHead">מוֹצָא</p>
                        <p class="storeType">בר כיף</p>
                    </div>
                    <div class="stkData">
