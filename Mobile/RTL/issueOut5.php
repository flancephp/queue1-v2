...
<head>
    ...
    <title>Issue Out5 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="issueOut4.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            ...
            <div class="text-center">
                <a href="issueOut6.php" class="fnshBtn fnshUpldBtn">סיום והעלה <img src="../Assets/icons/download.svg"
                        alt="Finish"></a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="productList d-flex align-items-center">
                ...
                <div class="prdctValue fnPrd-Val">
                    <p class="prdUnit"><span class="unitNum">1</span> פַּח</p>
                </div>
            </div>
