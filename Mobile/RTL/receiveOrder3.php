...
<head>
    ...
    <title>Receiving3 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="receiveOrder2.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            ...
            <div class="row align-items-center pt-3">
                <div class="col-md-6 mblSrchClm d-flex align-items-center">
                    <div class="input-group srchBx" style="border-color: rgb(213, 214, 221);">
                        <input type="search" class="form-control" placeholder="לחפש" id="srch" aria-label="Search">
                ...
                <div class="col-md-6 mblFnsClm d-flex justify-content-end">
                    <div class="d-flex align-items-center fnshGrp">
                        <p class="countValue"><span class="countedItm">3</span><span>/5</span></p>
                        <a href="receiveOrder4.php" class="finishBtn">סיים <span><i
                ...
                <div class="recPrdt-Div">
                    <div class="recPrd-List d-flex align-items-center">
                        ...
                        <div class="prdctDtl rcvPrd-Dtl">
                            <p class="prdName">זן אקווה מים...</p>
                        ...
                        <div class="prdctValue rcvPrdVal">
                            <div class="receiveQty"><input type="text" value="" class="form-control prdForm"
                                    placeholder="1">
                                <p class="recQty-Unit">בקבוק</p>
                            </div>
                            <div class="receiveQty"><input type="text" value="" class="form-control prdForm"
                                    placeholder="1">
                                <p class="recQty-Prc">$</p>
                            </div>
                        </div>
                    </div>
