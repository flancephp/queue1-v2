...
<head>
    ...
    <title>Outlet Stocktaking5 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="outletStocktaking4.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            ...
            <div class="text-center">
                <a href="outletStocktaking6.php" class="fnshBtn fnshUpldBtn">סיום והעלה <img
