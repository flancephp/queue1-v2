...
<body>
    ...
    <section class="headSec">
        <div class="container">
            ...
            <div class="d-flex align-items-center justify-content-between pt-3 upldClm">
                ...
                <a href="issueOut6.php" class="fnshBtn">Finish & Upload <img src="Assets/icons/download.svg"
                        alt="Finish"></a>
            </div>
        </div>
    </section>
    ...
    <section class="finishSection">
        <div class="container">
            <div class="scflMsg">
                <p class="text-center">All <span class="numItems">0</span> items counted successfully</p>
            </div>
