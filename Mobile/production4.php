...
<head>
    ...
    <title>Production4 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="production3.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
    ...
    <section class="fnlSection">
        <div class="container">
            <div class="msgBx-Stock text-center">
                ...
                <p>Production done successfully.</p>
                <a href="index.php" class="homeBtn"><i class="fa-solid fa-arrow-left"></i> <span>Home</span></a>
            </div>
        </div>
    </section>
