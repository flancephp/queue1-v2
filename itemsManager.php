...
$sql = " SELECT * FROM tbl_designation_sub_section_permission WHERE type = 'item_manager' AND designation_Section_permission_id = '8' AND designation_id = '" . $_SESSION['designation_id'] . "' AND account_id = '" . $_SESSION['accountId'] . "' ";
...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 767px) {
            ...
            html[dir="rtl"] .itmMng-Src .col-md-6 {
                margin-left: auto;
                margin-right: 0;
            }
                                    ...
                                    <form action="itemsManager.php" id="upload_form" name="upload_form"
                                        ...
                                        <div class="dropdown">
                                            <a
                                                ...
                                                <span class="pe-2">
                                                    <svg width="32" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31 30">
                                                        <path d="M25.7 7.7q2.5-.1 3.2.4l.7.7q.5.8.4 3.2v11.5q.2 3.3-.7 4.1-.9 1-4.2.8H18q-3.3.2-4.2-.8c-.7-.7-.7-1.8-.7-4.1V12q-.1-2.4.4-3.2l.7-.7q.7-.5 3.1-.4" stroke="#8C8FA7" stroke-width="2" />
                                                        <path d="M17.9 7.7c0-1.3 1-2.4 2.4-2.4h2.4a2.4 2.4 0 1 1 0 4.8h-2.4Q18 10 17.9 7.7Z" stroke="#8C8FA7" stroke-width="2" />
                                                        <path d="M17.9 16.2H25M17.9 21h4.8" stroke="#8C8FA7" stroke-width="2" stroke-linecap="round" />
                                                        <path d="m5 19-.7.6.7.7.7-.7zM6 7a1 1 0 1 0-2 0zM.3 15.5l4 4 1.4-1.4-4-4zm5.4 4 4-4-1.4-1.4-4 4zM6 19V7H4v12z" fill="#8C8FA7" />
                                                    </svg>
                                                </span>
                                ...
                                <div class="align-items-center drpItm-MngClm drpHead-ItmMng">
                                    <div class="tb-head drpDwn-ItmMng subCat-ItmMng">
                                        ...
                                        <input type="hidden" name="subCatId" id="subCatId"
                                            value="<?php if (isset($_GET['subCatId'])) {
                                                        echo $_GET['subCatId'];
                                                    } ?>">
                                    </div>
                                    <div class="tb-head drpDwn-ItmMng supItm-Mng">
                                        ...
                                        <input type="hidden" name="suppId" id="suppId"
                                            value="<?php if (isset($_GET['suppId'])) {
                                                        echo $_GET['suppId'];
                                                    } ?>">
                                    </div>
                                    <div class="tb-head drpDwn-ItmMng deptItm-Mng">
                                        ...
                                        <input type="hidden" name="deptId" id="deptId"
                                            value="<?php if (isset($_GET['deptId'])) {
                                                        echo $_GET['deptId'];
                                                    } ?>">
                                    </div>
                                    <div class="tb-head drpDwn-ItmMng strgItm-Mng">
                                        ...
                                        <input type="hidden" name="storeId" id="storeId"
                                            value="<?php if (isset($_GET['storeId'])) {
                                                        echo $_GET['storeId'];
                                                    } ?>">
                                    </div>
                                </div>
