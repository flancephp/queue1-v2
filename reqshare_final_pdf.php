    ...
    <tr valign="top">
     ...
     $content .= '<table width="100%" style="font-size: 12px; line-height: 14px; border-spacing: 0; margin-top: 20px;">';   
       ...
       $content .=   '<tr>';
        if(  $_GET['taskNo']  == 1 ) 
        {
         $content .=   '<td style="font-weight:700;padding: 5px;">Task No.</td>';
        }
        ...
        $content .= '</tr>';//end sup det
            ...
            <td width="28%">
                <table style="width: 100%;border-collapse: collapse;">
                    <tr>
                        <td width="40%" style="padding: 5px;">'.showOtherLangText('Sub Total').'</td>
            ...
            <td width="28%">
                <table style="width: 100%;border-collapse: collapse;">
                    <tr>
                        <td width="40%" style="padding: 5px;">'.$row['feeName'].'</td>
