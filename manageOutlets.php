                ...
                <section class="ordDetail userDetail">
                    <div class="container">
                        <div class="usrBtns d-flex align-items-center justify-content-between">
                            ...
                            <div class="usrAd-Btn">
                                <div class="btnBg">
                                    <a href="addOutlet.php" class="sub-btn std-btn mb-usrBkbtn"><span
                                    ...
                                    <div class="usrTbl-body align-items-center itmBody">
                                        ...
                                        <div class="outTbl-Icns">
                                            <div class="tb-bdy outOpt-Clm d-flex align-items-center">
                                                <a href="editOutlet.php" class="userLink">
                                ...
                                <div class="userTask">
                                    <div class="usrTbl-body align-items-center itmBody">
                                        <div class="outTbl-Cnt d-flex align-items-center">
                                            ...
                                            <div class="tb-bdy outName-Clm">
                                                <p class="userName">Casa Office</p>
                                            </div>
                                        </div>
                                        <div class="outTbl-Icns">
                                            <div class="tb-bdy outOpt-Clm d-flex align-items-center">
