...
while ($row = mysqli_fetch_array($ordQry)) //show here order level charges
{
  ...
  if ($row) {
    if ($ordersRow['ordCurId'] > 0) {
      $content .= '<tr style="color:#666C85; font-size:18px;line-height:21.78px;text-align:left;height:38px;border:none !important;font-weight: bold; max-height: 38px;">
<th style="font-size:16px;font-weight:600;line-height:21.78px;padding:0 12px !important;border-radius:10px 0 0 10px !important;">' . $row['feeName'] . '</th>
<th style="font-size:16px;font-weight:600; color: #232859;line-height:21.78px;padding:0 12px !important;border-radius:0 10px 10px 0 !important;">' . showOtherCur($discountPercentOther, $ordersRow['ordCurId']) . '</th>
 </tr>';
    } else {
      $content .= '<tr style="color:#666C85; font-size:18px;line-height:21.78px;text-align:left;height:38px;border:none !important;font-weight: bold; max-height: 38px;">
<th style="font-size:16px;font-weight:600;line-height:21.78px;padding:0 12px !important;border-radius:10px 0 0 10px !important;">' . $row['feeName'] . '</th>
...
while ($row = mysqli_fetch_array($ordQry)) //show here order level charges
{
  ...
  if ($ordersRow['ordCurId'] > 0) {
    $content .= '<tr style="color:#666C85; font-size:18px;line-height:21.78px;text-align:left;height:38px;border:none !important;font-weight: bold; max-height: 38px;">
<th style="font-size:16px;font-weight:600;line-height:21.78px;padding:0 12px !important;border-radius:10px 0 0 10px !important;">' . $row['feeName'] . '</th>
<th style="font-size:16px;font-weight:600; color: #232859;line-height:21.78px;padding:0 12px !important;border-radius:0 10px 10px 0 !important;">' . showOtherCur($taxChargesOther, $ordersRow['ordCurId']) . '</th>
</tr>';
  } else {
    $content .= '<tr style="color:#666C85; font-size:18px;line-height:21.78px;text-align:left;height:38px;border:none !important;font-weight: bold; max-height: 38px;">
<th style="font-size:16px;font-weight:600;line-height:21.78px;padding:0 12px !important;border-radius:10px 0 0 10px !important;">' . $row['feeName'] . '</th>
