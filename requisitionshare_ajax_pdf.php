...
$sql = "SELECT od.*, tp.itemName, tp.barCode, tp.imgName, IF(u.name!='', u.name, tp.unitC) countingUnit FROM tbl_order_details od 
		...
		WHERE od.ordId = '" . $_POST['orderId'] . "' AND od.account_id = '" . $_SESSION['accountId'] . "' and od.qty > 0 order by tp.catId ";
...
$content  .= '<form action="req_pdf_download.php" target="_blank" method="get">
        <input type="hidden" name="getLangType"  id="getLangType" value="' . $getLangType . '" />  
        ...
        <div class="modal-header filter-header-top position-relative">
                                ...
                                <div class="collapse" id="modalfiltertop">
                                    ...
                                    <div class=" dropdown">
                                        ...
                                        <ul class="dropdown-menu px-3 summaryArea" aria-labelledby="headers">
                                            <li>
...
$content  .=     '</div></div>
                                ...
                                <div class="modal-table fs-12 w-100 table__cel__alignment requestion__modal__table">
                                    <div class="table-row header-row sumMainDiv" >
                                    ...
                                    <div class="table-row thead sumMainDiv">
...
if ($ordDet['invNo'] != '') {
    ...
    $content .= ' <div class="table-cell" style="width: 20%;"></div>';
}

$content .= '  
                                    <div class="table-cell" style="width: 20%;"></div>
                                    <div class="table-cell" style="width: 20%;"></div> 
                                    <div class="table-cell p-0" style="width: 40%;">';
...
while ($row = mysqli_fetch_array($otherChrgQry)) {
    $i++;
    $content .=  '<div class="table-row itemMainDiv">';
    $content .=  '<div class="table-cell" class="slno">' . $i . '</div>';
    $img = '';
    ...
    $content .=  '<div class="table-cell"><span    class="itmCode"></span></div>';
    ...
    $content .=   '<div class="table-cell"><span    class="itmRecqty">1</span></div>';
