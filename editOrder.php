...
$sql = " SELECT * FROM tbl_designation_sub_section_permission WHERE type = 'edit_order' AND designation_Section_permission_id = '8' AND designation_id = '" . $_SESSION['designation_id'] . "' AND account_id = '" . $_SESSION['accountId'] . "' ";
