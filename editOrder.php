...
$sql = " SELECT * FROM tbl_designation_sub_section_permission WHERE type = 'edit_order' AND designation_Section_permission_id = '3' AND designation_id = '" . $_SESSION['designation_id'] . "' AND account_id = '" . $_SESSION['accountId'] . "' ";
...
<head>
    ...
    <style>
        ...
        @media(min-width:992px) {
            ...
            html[dir="rtl"] .nwNxt-Btn.nwNxt-Btn1.ps-lg-4 {
        ...
        @media (max-width:992px) {
            ...
            .edit-order-section.update .prdtCnt-Scnd {
                width: 25% !important;
            }

            .edit-order-section.update .prdtCnt-Scnd .itm-Quantity,
            .edit-order-section.update .prdtCnt-Scnd .ttlCr-Type {
                width: 100% !important;
            }

            .edit-order-section .itm-Unit.tb-bdy {
                width: 40%;
            }

            .prdtCr-Unit .crncy-Type.w-50 {
                width: 60% !important;
            }
            ...
            .edit-order-section .Itm-Name.tb-bdy p {
                overflow: hidden;
            ...
            html[dir="rtl"] .sltSupp.nwOrd-Num.position .ord-Box {
                border-radius: 10px !important;
                border-right: 1px solid #94ebc6;
            }
            ...
            html[dir="rtl"] .update .ordInfo {
                padding: 0;
            }

            .col-lg-9.col-xl-10.newFeature {
                order: 3;
                padding-top: .5rem;
            }

            .container.pt-5.topOrder {
                padding: 0 !important;
            }

            .mbFeature .ms-auto.text-center.w-100 {
                margin: 10px 0 4px auto !important;
            }

            html[dir="rtl"] .mbFeature .ms-auto.text-center.w-100 {
                margin: 8px auto 3px 0 !important;
            }
        }
        ...
        @media screen and (max-width: 575px) {
            ...
            .update .add-new-items.btn-primary {
                width: 100%;
            }

            .edit-order-section .ttlCr-Type.d-flex.align-items-center {
        ...
        .edit-order-section.update .ttlCr-Type .ttlOtr-Crcy,
        .edit-order-section.update .ttlCr-Type .ttlDft-Crcy,
        .edit-order-section.update .ttlCr-Type,
        .edit-order-section.update .ttlCr-Type {
        ...
        html[dir="rtl"] .edit-order-section.update .ttlCr-Type .ttlOtr-Crcy,
        html[dir="rtl"] .edit-order-section.update .ttlCr-Type .ttlDft-Crcy,
        html[dir="rtl"] .edit-order-section.update .ttlCr-Type,
        html[dir="rtl"] .edit-order-section.update .ttlCr-Type,
        html[dir="rtl"] .edit-order-section.update .ttlCr-Type .text-start {
        ...
        @media (max-width:991px) {
            ...
            .mb-brCode .ord-StockQty .tabOn-Stk {
                white-space: nowrap;
            }
        }
...
WHERE od.ordId = '" . $_GET['orderId'] . "' AND tp.account_id = '" . $_SESSION['accountId'] . "' ORDER BY tp.itemName ";
                            ...
                            <div class="d-flex align-items-center itmTable">
                                <div class=" tb-head" style="width: 44px;">
                                    <p><?php
                                        ...
                                        $totalRows = mysqli_num_rows($ordQry) > 0 ? mysqli_num_rows($ordQry) : '';
                                        echo $totalRows += mysqli_num_rows($chrgQry) > 0 ? mysqli_num_rows($chrgQry) : $totalRows;
                        ...
                        <div id="boxscroll" class="compact__tb__bdy">
                            <div class="container cntTable">
                                ...
                                $x = 0;
                                $y = 0;
                                while ($row = mysqli_fetch_array($chrgQry)) //show here custom item charges
                                {
                        ...
                        <div>
                            ...
                            <div class="container mt-lg-5 topOrder">
                                <div class="row gy-3 gx-0 g-md-4 align-items-end">
                                    ...
                                    <div class="col-md-7">
                                        <!-- <form id="add-new-items" action="editOrderAddNewItems.php?orderId=<?php //echo $_GET['orderId'];
