    ...
    <style>
        ...
        @media(min-width:992px) {
            ...
            html[dir="rtl"] .ord-Box {
                ...
                border-left: 1px solid #F05D53 !important;
            }

            html[dir="rtl"] .featRow.ms-auto.w-100 {
        ...
        @media(min-width:768px) {
            html[dir="rtl"] .btnBg.text-center.text-md-end {
                text-align: left !important;
            }
        }
        ...
        @media(min-width:576px) {
            ...
            html[dir="rtl"] .container.mt-5.topOrder {
                    {
                    padding: 0 1.5rem;
                }
            }
        ...
        @media(min-width:992px) {
            ...
            html[dir=rtl] .edtreqInfo {
                padding: 0 50px 0 68px;
            }

            html[dir=rtl] .col.newFeature {
        ...
        @media (max-width: 991px) {
            ...
            .edit-order-section.update .prdtCnt-Scnd.d-flex.align-items-center {
                width: 25% !important;
            }
        ...
        @media(max-width:991px) {
            ...
            .prdtImg.tb-bdy .ordItm-Img {
                position: relative;
                top: 10px;
            }

            html[dir="rtl"] .container.mt-3.mt-md-4.mt-lg-5.topOrder,
            html[dir="rtl"] .container.pb-4.topOrder {
                padding-left: 10px;
                padding-right: 10px;
            }
        }
                            ...
                            <div class="d-flex align-items-center itmTable">
                                <div class="prdtImg tb-head">
                                    <p><?php
                                        ...
                                        $total_edit_req_prodts =  mysqli_num_rows($orderQry) > 0 ? mysqli_num_rows($orderQry) : '';
                                        echo $total_edit_req_prodts += mysqli_num_rows($chrgQry) > 0 ? mysqli_num_rows($chrgQry) : ''; ?></p>
