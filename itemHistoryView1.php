                                    ...
                                    <div class="itmView-isuTbl d-flex justify-content-center text-center">
                                        ...
                                        <div class="itmVw-varPtive">
                                            ...
                                            <div style="display: flex; gap:5px; justify-content: space-evenly">
                                                <p class="viewItm-varPlus varDif"><?php showPrice($resItemHistory['variancesTot'],$getDefCurDet['curCode']);?></p>
                                        ...
                                        <div class="itmVw-varNtive">
                                            ...
                                            <p class="viewItm-varMinus "><?php showPrice($resItemHistory['issuedOutTot'],$getDefCurDet['curCode']);?></p>
                                            <p class="varMinus-countUnt "><?php echo $resItemHistory['issuedOutQtyTot'];?><?php echo $res['countingUnit'];?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
