...
$content .= '<td>
      <table style=" text-align: left; width: 100%; border-collapse: collapse;">
        <tbody>
          <tr>
            <td style="padding:0;font-size:16px;font-weight:600;line-height:19px;color:#666C85 !important;">' . reverseRTLTextForPdf($clientResultRow['accountName']) . '</td>
          </tr>
          <tr>
            <td style="padding:0;font-size:16px;font-weight:600;line-height:19px;color:#666C85 !important;">' . reverseRTLTextForPdf($clientResultRow['address_one']) . ',' . reverseRTLTextForPdf($clientResultRow['address_two']) . '</td>
          </tr>
          <tr>
            <td style="padding:0;font-size:16px;font-weight:600;line-height:19px;color:#666C85 !important;">' . reverseRTLTextForPdf($clientResultRow['city']) . ',' . reverseRTLTextForPdf($resultRow['name']) . '</td>
          </tr>
          <tr>
            <td style="padding:0;font-size:16px;font-weight:600;line-height:19px;color:#666C85 !important;">' . reverseRTLTextForPdf($clientResultRow['email']) . '</td>
          </tr>
          <tr>
...
$content .= '</tr>
        ...
        <div style="padding-right:1rem;">
          <p style="font-size:16px;font-weight:600;line-height:19.36px;text-align: right; margin-bottom: .5rem;">' . showOtherLangText('Invoice To') . ':</p>
          <p style="margin: 0; font-size:16px;font-weight:600;line-height:19.36px;text-align: right;color:#666C85; margin-bottom: 0;">' . reverseRTLTextForPdf($paymentInfoRow['invoiceName']) . '</p>
          <p style="margin: 0; font-size:16px;font-weight:600;line-height:19.36px;text-align: right;color:#666C85; margin-bottom: 0;">' . reverseRTLTextForPdf($paymentInfoRow['invoiceAddress']) . '</p>
          <p style="margin: 0; font-size:16px;font-weight:600;line-height:19.36px;text-align: right;color:#666C85; margin-bottom: 0;">' . reverseRTLTextForPdf($paymentInfoRow['invoiceEmail']) . '</p>
          <p style="margin: 0; font-size:16px;font-weight:600;line-height:19.36px;text-align: right;color:#666C85; margin-bottom: 0;">' . $paymentInfoRow['invoicePhone'] . '</p>
        </div>
...
$content .= '<tr><td colspan="2" style="padding:4px;"></td></tr><tr style="text-align: right;height:38px;border:none !important;font-weight: bold; max-height: 38px;margin-top:10px;">
            <th style="background:#7A89FF;color:white;font-size:18px;font-weight:600;line-height:21.78px;padding:6px 12px !important;border-radius:0 10px 10px 0 !important;text-align: right;">' . getPriceWithCur($netTotalAmt, $getDefCurDet['curCode'], 0, 1) . '</th>
            
<th style="background:#7A89FF;color:white;font-size:18px;font-weight:600;line-height:21.78px;padding:6px 12px !important;border-radius:10px 0 0 10px !important;text-align: right;">' . showOtherLangText('Grand Total') . '</th>
          </tr>';
...
$content .=  '</tbody>
    ...
    <td style="vertical-align: top; width:60%; ">
      <p style="margin: 0px; font-size:16px;font-weight:600;line-height:19.36px;text-align: right; margin-bottom: 0;">:' . showOtherLangText('Payment Method') . '</p>';
...
$content .= '<p style="margin: 0px; font-size:16px;font-weight:600;line-height:19.36px;text-align: right;color:#666C85; margin-bottom: 0;">' . reverseRTLTextForPdf($payModeRow['modeName']) . '</p>';
$content .= '<p style="margin: 0px; font-size:16px;font-weight:600;line-height:19.36px;text-align: right;color:#666C85; margin-bottom: 0;">' . reverseRTLTextForPdf($accDet['accountName']) . '</p>';
$content .= '</td>
