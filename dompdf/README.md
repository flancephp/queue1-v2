...
Note that some oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required dependencies may have further dependencies 
