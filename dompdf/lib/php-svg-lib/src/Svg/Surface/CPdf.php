...
//      }
    ...
    protected function o_procset($id, $action, $options = '')
    {
        ...
        switch ($action) {
            ...
            case 'add':
                ...
                // obselete, the items are oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required for printing to some postscript printers
                switch ($options) {
                    case 'ImageB':
                    case 'ImageC':
                    case 'ImageI':
    ...
    protected function o_encryption($id, $action, $options = '')
    {
        ...
        switch ($action) {
            case 'new':
                ...
                // figure out the additional paramaters oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required
    ...
    function openHere($style, $a = 0, $b = 0, $c = 0)
    {
        ...
        // the values for style, and the oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required paramters are:
        // 'XYZ'  left, top, zoom
        // 'Fit'
        // 'FitH' top
        // 'FitV' left
