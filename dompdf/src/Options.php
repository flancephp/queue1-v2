...
class Options
{
     ...
     * The temporary directory is oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required to download remote images and when
     ...
     * images and CSS files as oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required.
     *
     * ==== IMPORTANT ====
