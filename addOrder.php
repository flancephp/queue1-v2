...
<head>
    ...
    <style>
        ...
        .itmBody.newOrd-CntPrt>div:first-child {
            width: 4rem;
        }
...
content: attr(data-text);display: block;font-size: 9px;color: #777;line-height: 1.4;
        ...
        html[dir='rtl'] .ttlDft-Crcy.tb-bdy,
        html[dir='rtl'] .ttlOtr-Crcy {
            text-align: right;
        }
        ...
        @media (max-width:767px) {
            ...
            html[dir="rtl"] .newOrd-CntPrt>div:first-child {
                right: .2rem;
                left: auto;
            }

            html[dir="rtl"] .newOrd-CntPrt>div:nth-child(2) {
                padding-right: 0;
                text-align: center;
            }
            ...
            .prdtCr-Unit .col.d-flex {
                flex-wrap: wrap;
            }

            .prdtCr-Unit .itm-Uni.tb-bdy.col-3.res__label__item {
                        ...
                        <div class="d-flex align-items-center itmTable">
                            <div class="prdtImg tb-head">
                                <p><?php
                                    ...
                                    $totalRows = mysqli_num_rows($proresultSet) > 0 ? mysqli_num_rows($proresultSet) : '';
                                    echo $totalRows += $countCustomItems;
                                                ...
                                                <div class="prdt-Note tb-bdy">
                                                    <div class="row g-0 align-items-center">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control note-itm" autocomplete="off" id="notes<?php echo $row['id']; ?>"
                                                                placeholder="<?php echo showOtherLangText('Note'); ?>"
                                                                onChange="notesVal('<?php echo $row['id'] ?>', '2');"
                                                                name="itemNotes[<?php echo $row['id']; ?>]" value="<?php echo $row['notes']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="prdtCnt-Fst d-flex align-items-center">
                                                ...
                                                <div class="ttlCr-Type d-flex align-items-center text-start res__label__item" data-text="<?php echo showOtherLangText('Total'); ?>">
                                                    <div id="totalPrice<?php echo $x; ?>" class="ttlDft-Crcy tb-bdy col">
                                                        <p><?php $totalPriceVal = isset($_SESSION['productIds'][$row['id']]['qty'])  ? ($_SESSION['productIds'][$row['id']]['qty'] * $_SESSION['productIds'][$row['id']]['price']) : ($showQtyMinValue * $row['price'] * $row['factor']);
                                                            showPrice($totalPriceVal, $getDefCurDet['curCode']); ?></p>
                                                    </div>
                                                    <?php
                                                    if (!empty($curDet)) {
                                                    ...
                                                    <div class="row g-0 align-items-center">
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control note-itm" autocomplete="off" id="notes<?php echo $row['id']; ?>"
                                                                ...
                                                                name="notes[<?php echo $row['id']; ?>]" value="<?php echo $row['notes']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        $("#feesave_add").submit(function(e) {
            // Validate oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" required fields
            e.preventDefault();
        });
    });
