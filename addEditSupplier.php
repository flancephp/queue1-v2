                                ...
                                <div class="row align-items-center acntStp-Row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" value="<?php echo $res['name']; ?>"
                                            id="name" name="name" oninvalid="this.setCustomValidity('<?php echo showOtherLangText('Please fill out this field.') ?>')" onChange="this.setCustomValidity('')" required placeholder="<?php echo showOtherLangText('Supplier') ?>">
                                    </div>
                                </div>
