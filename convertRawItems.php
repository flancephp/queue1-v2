...
<form method="post" id="stocksubmit" action="stockView.php" autocomplete="off">
    ...
    <div class="modal-body d-flex flex-column gap-3">
        ...
        <div class="d-flex align-items-center">
            <div class="col-10">
                <input type="text" name="unitPrice" id="unitPrice" class="form-control mt-0 w-100"
    ...
    <div class="modal-footer">
        <div class="btnBg">
            <button type="submit" name="btnSbt" onclick=""
                class="deletelink btn btn-primary std-btn"><?php echo showOtherLangText('Save'); ?></button>
        </div>
        <div class="btnBg">
            <button type="button" data-bs-dismiss="modal"
                class="btn btn-primary std-btn"><?php echo showOtherLangText('Cancel'); ?></button>
        </div>
    </div>
</form>
<script>
