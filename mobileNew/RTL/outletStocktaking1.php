...
<head>
    ...
    <title>Outlet Stocktaking1 - Queue1 Mobile</title>
...
<body>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    ...
                    <h2 class="mblFnt2">אאוטלט סקירת מלאי</h2>
                </div>
                <div class="col-md-6">
    ...
    <section class="strgList">
        <div class="container">
            <a href="outletStocktaking2.php" class="strgProduct">
                <div class="row">
                    <div class="col-md-6 storeClm">
                        <p class="storeName">חוף כיף</p>
                        <p class="storeName">בר כיף</p>
                        <p class="prdCode"># 107534</p>
                    </div>
                    <div class="col-md-6 countClm">
                        <p class="prdItm-Count">22/22 פריט</p>
                        <p class="prdItm-Count">&nbsp;</p>
                        <p class="PrdDate">16/01/2023</p>
                    </div>
                </div>
            </a>
            <a href="outletStocktaking2.php" class="strgProduct mt-3">
                <div class="row">
                    <div class="col-md-6 storeClm">
                        <p class="storeName">חוף כיף</p>
                        <p class="storeName">בר כיף</p>
