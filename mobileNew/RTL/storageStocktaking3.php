...
<head>
    ...
    <title>Storage Stocktaking3 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="storageStocktaking2.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            ...
            <div class="row align-items-center pt-3">
                ...
                <div class="col-md-6 mblFnsClm d-flex justify-content-end">
                    <div class="d-flex align-items-center fnshGrp">
                        <p class="countValue"><span class="countedItm">4</span><span>/121</span></p>
                        <a href="storageStocktaking4.php" class="finishBtn">סיים <span><i
