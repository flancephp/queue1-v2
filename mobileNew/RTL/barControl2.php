...
<head>
    ...
    <title>Bar Control2 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="barControl1.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            ...
            <div class="row align-items-center pt-3">
                ...
                <div class="col-md-6 mblFnsClm d-flex justify-content-end">
                    <div class="d-flex align-items-center fnshGrp">
                        <p class="countValue"><span class="countedItm">3</span><span>/96</span></p>
                        <a href="barControl3.php" class="finishBtn">סיים <span><i
    ...
    <section class="prdctSection">
        <div class="container">
            <div class="productList d-flex align-items-center">
                <div class="prdctImg">
                    <img src="../Assets/images/amaretto.png" alt="Product">
                </div>
                <div class="prdctDtl">
                    <p class="prdName">אמרטו דיסרון..</p>
