<?php
    if($barControlStep == 1){?>
        ...
        <div class="col-md-6 bckClm">
            <a href="<?php echo $mobileSiteUrl;?>barControl2.php?stockTakeId=<?php echo $_GET['stockTakeId'];?>&revenueId=<?php echo $_GET['revenueId']?>&start=1" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            <h2 class="mblFnt2"><?php echo isset($stockTakeRow['name']) ? $stockTakeRow['name'] : ' '.showOtherLangText('Select Storage').' ';?></h2>
        </div>
        <?php
    }
