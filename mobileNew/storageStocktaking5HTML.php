...
<head>
    ...
    <title>Storage Stocktaking5 - Queue1 Mobile</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 bckClm">
                    <a href="storageStocktaking4.php" class="mblBack-Btn"><i class="fa-solid fa-chevron-left"></i></a>
            ...
            <div class="text-center">
                <a href="storageStocktaking6.php" class="fnshBtn fnshUpldBtn">Finish & Upload <img
        ...
        <div class="container">
            <div class="productList d-flex align-items-center">
                ...
                <div class="prdctValue fnPrd-Val">
                    <p class="prdUnit"><span class="unitNum">5</span> Pkt</p>
                </div>
            </div>
