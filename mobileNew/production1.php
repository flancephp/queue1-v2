...
<head>
    ...
    <title>Production1 - Queue1 Mobile</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 bckClm">
                    ...
                    <h2 class="mblFnt2">Production</h2>
    ...
    <section class="strgList">
        ...
        <div class="container">
            ...
            <a href="production2.php" class="strgProduct production-Prd">
                <div class="inner__content bg-white"> 
                    <div class="row g-0">
    
                        <div class="col-md-6 storeClm">
    
                            <p class="storeName ellipsis">Prep Kitchen</p>
    
                            <p class="storeName ttlStr-Cost mb-1">Total: <span>140 $</span></p>
            ...
            <a href="production2.php" class="strgProduct production-Prd mt-3">
                <div class="inner__content bg-white"> 
                    <div class="row g-0">
                ...
                <div class="inner__content bg-white">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-6 storeClm">
                            ...
                            <p class="storeNameellipsis">Prep Kitchen</p>
