...
<head>
    ...
    <style>
        ...
        .cntTable1 .stkNamcol { width: 65%; justify-content: space-evenly; } 
        ...
        @media (min-width:767px) {
            ...
            .mbShw .stkPrcol .lstPrcol { width: 50% !important; }
            .stockView .cntTable{padding: 0 30px !important;}
            .stkTblhead{padding: 0 30px !important;}
            #page2head.stkTblhead .mbShw, .page2bdy .cntTable .mbShw { width: 75%; }
            #page2head.stkTblhead .mbHde, .page2bdy .cntTable .mbHde { width: 25%; }  
        ...
        .cntTable .stkNamcol > div:nth-child(4),.stkTblhead .stkNamcol > div:nth-child(4) { width: 13.5%; } 
        ...
        .tb-bdy.stkImgcol .imgItm { height: 60px;width:50px; }
        .tb-bdy { padding: 5px 8px; }
        @media screen and (min-width: 1600px) { .tb-bdy { padding: 2px 8px; } }
    </style>
</head>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 expStrdt d-flex justify-content-end align-items-end">
                                    <div class="d-flex justify-content-end align-items-center">
                                        <div class="chkStore">
                                            <a href="javascript:void(0)" style="height: 20px;" id="toggle-page-btn"
                                                class="cstBtn-Sale toggle-page-btn hideBtn-Info ">
                                                <img src="Assets/icons/info.svg" style="height: 100%;" alt="Information"
                                                    class="cstBtn-Img">
                                            </a>
                                        ...
                                        <div class="chkStore">
                                            <a href="javascript:void(0)">
                                                <img src="Assets/icons/chkColumn.svg" class="flDwn-Icn" id="filterBtn"
                                                    title="Filter column list" alt="Check Column">
                                            </a>
                                        </div>
                                        <div class="chkStore">
                                ...
                                <div class="stkNamcol d-flex align-items-center">
                                    <div class="tb-head stkItmclm">
                                        <div class="d-flex align-items-center w-20">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask', '.stkItmclm','asc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask', '.stkItmclm','desc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                        ...
                                        <div class="d-flex justify-content-en align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask', '.stkQtybdy','asc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask', '.stkQtybdy','desc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                        ...
                                        <div class="d-flex justify-content-en align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask', '.stkavabdy','asc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask', '.stkavabdy','desc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                ...
                                <div class="stkPrcol d-flex align-items-center">
                                    <div class="tb-head lstPrcol">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask', '.mb-Last','asc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask', '.mb-Last','desc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="tb-head lstPrcol">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask', '.mb-Stock','asc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask', '.mb-Stock','desc');"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="dropdown d-flex position-relative w-100">
                                            <a class="dropdown-toggle body3" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <span
                                                    id="subcatText"><?php echo showOtherLangText('Sub Catagory'); ?></span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <?php } else { ?><div class="dropdown d-flex position-relative w-100">
                                            <a class="dropdown-toggle body3" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                <span
                                                    id="SupplierText"><?php echo showOtherLangText('Supplier'); ?></span>
                                                <i class="fa-solid fa-angle-down"></i>
                                            </a>
                    ...
                    <div class="container  stkTblhead position-relative tbl-head-page-1" id="page2head" style="display: none;">
                        ...
                        <div class="d-flex align-items-center itmTable" style="min-height: 70px;">
                            <div class="mbShw d-flex align-items-center">
                                ...
                                <div class="stkNamcol d-flex align-items-center">
                                    <div class="tb-bdy" style="padding:8px 8px 10px">
                                        <div class="d-inline-flex align-items-center" style="color: #000;"> 
                                            <p><?php echo showOtherLangText('Item'); ?></p>
                                            <span class="dblArrow">
                                    ...
                                    <div class="tb-head stkbarclm">
                                        <div class="d-flex align-items-center w-20">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.stkItmclm','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.stkItmclm','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="tb-head w-55  stkbarclm">
                                        <div class="d-flex justify-content-en align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.unit_p','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.unit_p','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="tb-head w-55  stkQtyclm">
                                        <div class="d-flex justify-content-en align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.factor','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.factor','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="tb-head w-55 stkQtyclm">
                                        <div class="d-flex justify-content-en align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.unit_c','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.unit_c','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                ...
                                <div class="stkPrcol d-flex align-items-center">
                                    <div class="tb-head lstPrcol">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.tmp_qty','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.tmp_qty','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="tb-head lstPrcol">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.department','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.department','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                                    ...
                                    <div class="tb-head lstPrcol">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <span class="dblArrow">
                                                <a onclick="sortTableByColumn('.newStockTask1', '.min_qty','asc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-up"></i></a>
                                                <a onclick="sortTableByColumn('.newStockTask1', '.min_qty','desc',1);"
                                                    href="javascript:void(0)" class="d-block aglStock"><i
                                                        class="fa-solid fa-angle-down"></i></a>
                                            </span>
                                            <?php } ?>
                            ...
                            <div class="mbHde align-items-center supData-Head">
                                <div class="tb-head supStkclm">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="dblArrow">
                                            <a onclick="sortTableByColumn('.newStockTask1', '.max_qty','asc',1);"
                                                href="javascript:void(0)" class="d-block aglStock"><i
                                                    class="fa-solid fa-angle-up"></i></a>
                                            <a onclick="sortTableByColumn('.newStockTask1', '.max_qty','desc',1);"
                                                href="javascript:void(0)" class="d-block aglStock"><i
                                                    class="fa-solid fa-angle-down"></i></a>
                                        </span>
                                        <?php } ?>
                                ...
                                <div class="tb-head supStkclm">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <span class="dblArrow">
                                            <a onclick="sortTableByColumn('.newStockTask1', '.stk_val','asc',1);"
                                                href="javascript:void(0)" class="d-block aglStock"><i
                                                    class="fa-solid fa-angle-up"></i></a>
                                            <a onclick="sortTableByColumn('.newStockTask1', '.stk_val','desc',1);"
                                                href="javascript:void(0)" class="d-block aglStock"><i
                                                    class="fa-solid fa-angle-down"></i></a>
                                        </span>
                                        <?php } ?>
                                    ...
                                    <div class="mbShw d-flex align-items-center">
                                        ...
                                        <div class="stkNamcol d-flex align-items-center">
                                            <div class="tb-bdy stkItmclm">
                                                <?php if(isset($stockUserFilterFields) && !in_array(2, $stockUserFilterFields) ) { ?>
                                                <?php } else { ?>
                                                <a href="itemHistoryView.php?id=<?php echo $row['id']; ?>"
                                                    class="itm-Profile"><?php echo $row['itemName']; ?></a>
                                                <?php } ?>
                                            </div>
                                        ...
                                        <div class="stkPrcol d-flex align-items-center">
                                            <div class="tb-bdy lstPrcol stkPrcbdy mb-Last">
                                                <?php if(isset($stockUserFilterFields) && !in_array(6, $stockUserFilterFields) ) { ?>
                                                <?php } else { ?> <p><span
                                                        class="mbLst-value">Last</span><?php echo getPrice($row['stockLastPrice']) .' '.$getDefCurDet['curCode']; ?>
                                                </p>
                                                <?php } ?>
                                            </div>
                                            ...
                                            <div class="tb-bdy lstPrcol stkPrcbdy mb-Stock">
                                                ...
                                                <?php } else { ?>
                                                <p><span
                                                        class="mbLst-value">Stock</span><?php echo getPrice($row['sPrice']) .' '.$getDefCurDet['curCode']; ?>
                                                </p>
                                                <?php } ?>
                                            </div>
                    ...
                    <form method="post" action="" class="shortList-ChkAll">
                        ...
                        <p style="display: flex; gap:.5rem;" class="mt-3">
                            <button type="submit" name="btnSubmit"
                                style="background-color: #7a89fe; border-radius: 10px; border: none; color:white; "
                                class="btn gray-btn">Show</button>&nbsp;
                            <button type="button" name="btnSubmit"
                                style="background-color: #7a89fe; border-radius: 10px; border: none; color:white; "
                                class="btn gray-btn"
                                onclick="window.location.href='stockView.php?clearshowFieldsStock=1'"><?php echo showOtherLangText('Clear Filter'); ?></button>
                        </p>
                    </form>
                </div>
